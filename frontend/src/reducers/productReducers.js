...
const stateProducList = {
    products: [],
};

const stateProductDetails = {
    product: { reviews: [] },
};

export const productListReducer = (state = stateProducList, action) => {
    switch (action.type) {
...
export const productDetailsReducer = (state = stateProductDetails, action) => {
    switch (action.type) {
